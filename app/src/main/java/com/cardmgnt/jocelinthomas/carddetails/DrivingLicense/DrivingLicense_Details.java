...
import com.cardmgnt.jocelinthomas.carddetails.Passport.PassportActivity;
...
public class DrivingLicense_Details extends AppCompatActivity {


    DBHelper database;
    RecyclerView recyclerView;
    DrivinglicenseAdapter recycler;
    List<DrivinglicenseModel> datamodel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driving_license__details);
        ...
        datamodel = new ArrayList<DrivinglicenseModel>();
        recyclerView = (RecyclerView) findViewById(R.id.recycle);

        coordinatorLayout = findViewById(R.id.coordinatorLayout);
        database = new DBHelper(this);
        datamodel = database.getdriverdata();
        recycler = new DrivinglicenseAdapter(this, datamodel);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               Intent intent = new Intent(DrivingLicense_Details.this, DrivingLicenseActivity.class);
  ...
  /*  @Override
    protected void onResume() {
        ...
        if (shouldExecuteOnResume) {
            ...
            startActivity(new Intent(DrivingLicense_Details.this, EnterPassword.class));
        } else {
    ...
    private void showMaterialCase(int i) {
        new MaterialShowcaseView.Builder(DrivingLicense_Details.this) // instantiate the material showcase view using Builder
    ...
    public void onBackPressed() {
        Intent intent = new Intent(DrivingLicense_Details.this,HomeActivity.class);
        startActivity(intent);
    }
