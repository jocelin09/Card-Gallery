...
public class PassportDetailsActivity extends AppCompatActivity {


    DBHelper database;
    RecyclerView recyclerView;
    PassportAdapter recycler;
    List<PassportModel> datamodel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datamodel = new ArrayList<PassportModel>();
        recyclerView = (RecyclerView) findViewById(R.id.recycle);

        coordinatorLayout = findViewById(R.id.coordinatorLayout);
        database = new DBHelper(this);
        datamodel = database.getpassdata();
        recycler = new PassportAdapter(this, datamodel);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PassportDetailsActivity.this, PassportActivity.class);
...
/*
    ...
    protected void onResume() {
        ...
        if (shouldExecuteOnResume) {
            ...
            startActivity(new Intent(PassportDetailsActivity.this, EnterPassword.class));
        } else {
    ...
    private void showMaterialCase(int i) {
        new MaterialShowcaseView.Builder(PassportDetailsActivity.this) // instantiate the material showcase view using Builder
    ...
    public void onBackPressed() {
        Intent intent = new Intent(PassportDetailsActivity.this,HomeActivity.class);
        startActivity(intent);
    }
}
