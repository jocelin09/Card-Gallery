...
public class DebitCardDetailsActivity extends AppCompatActivity {

    DBHelper database;
    RecyclerView recyclerView;
    DebitCardAdapter recycler;
    List<DebitCardModel> datamodel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datamodel = new ArrayList<DebitCardModel>();
        recyclerView = (RecyclerView) findViewById(R.id.recycle);

        coordinatorLayout = findViewById(R.id.coordinatorLayout);
        database = new DBHelper(this);
        datamodel = database.getDebitCardData();
        recycler = new DebitCardAdapter(this, datamodel);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DebitCardDetailsActivity.this, DebitCardActivity.class);
    ...
    private void showMaterialCase(int i) {
        new MaterialShowcaseView.Builder(DebitCardDetailsActivity.this) // instantiate the material showcase view using Builder
    ...
    public void onBackPressed() {
        Intent intent = new Intent(DebitCardDetailsActivity.this,HomeActivity.class);
        startActivity(intent);
    }
}
