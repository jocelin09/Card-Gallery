...
public class ResultFragment extends Fragment {
    ...
    private class DoneButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            //Toast.makeText(getActivity(), "4 can view the image in your gallery", Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        getActivity().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                dismissDialog();
                                getActivity().finish();
                                Toast.makeText(getActivity(), "You can view the scanned image in your gallery!!", Toast.LENGTH_SHORT).show();
                            }
